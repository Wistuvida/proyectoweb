                ...
                <div class="card-body">
                    ...
                    <form action="php/iniciar_sesion.php" method="POST">
                        <div class="input-group">
                            <input class="input--style-3" type="email" placeholder="Correo Electrónico" name="correo">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="password" placeholder="Contraseña" name="contrasena">
                        </div>
                        <div class="p-t-10">
