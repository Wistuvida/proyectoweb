    ...
    <center>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="card-title" style="text-align: center;">
                        <h1>Lucana Machaca Elvis</h1>
                        <p class="card-text">
                            Lucana Machca Elvis una persona bla bla bla Una biografía es un texto. ...</p>
                        </p>
                    </div>
                </div>
                </div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Datos contacto unidad educativa</h5>
                        <p class="card-text">Aqui agregas los datos de contacto.</p>
